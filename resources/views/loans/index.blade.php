...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    @can('loan.create')
    <button type="button" class="btn btn-primary js-open-create" data-create-url="{{ route('loans.create') }}">
...
@push('scripts')
    @include('partials._create_modal_js', ['formId' => 'loanCreateForm'])
@endpush
