<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('loans.store') }}" id="loanCreateForm" novalidate>
            @csrf
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('loans.index') }}" class="btn btn-outline-secondary" data-bs-dismiss="modal" type="button">
