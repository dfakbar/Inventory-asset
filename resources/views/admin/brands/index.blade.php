...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    ...
    @can('brand.create')
    <button type="button" class="btn btn-primary js-open-create" data-create-url="{{ route('admin.brands.create') }}">
...
@include('partials._search_bar', [
    ...
    'hint'        => 'Hasil pencarian untuk &ldquo;<strong>' . e(request('search')) . '</strong>&rdquo;. Pastikan merek belum terdaftar sebelum menambah merek baru.',
])
...
@push('scripts')
    @include('partials._create_modal_js', ['formId' => 'brandCreateForm'])
@endpush
