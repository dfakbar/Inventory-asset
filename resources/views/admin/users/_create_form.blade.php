            ...
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary" type="button" data-toggle-user-password title="Tampilkan/sembunyikan password">
                            <i class="bi bi-eye" data-toggle-icon></i>
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="role" name="role"
                            ...
                            onchange="toggleUserPermissions(this.value)" required>
        ...
        <div class="card shadow-sm border-0" id="permissions-card">
            <div class="card-header bg-dark text-white py-2 px-3 d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-sm btn-outline-light" onclick="checkAllPermissions(true)">
                        <i class="bi bi-check-all me-1"></i>Pilih Semua
                    </button>
                    <button type="button" class="btn btn-sm btn-outline-light" onclick="checkAllPermissions(false)">
                        ...
                        <div class="col-sm-6">
                            <div class="form-check p-3 border rounded {{ in_array($permName, old('permissions', [])) ? 'bg-primary bg-opacity-10 border-primary' : 'bg-light' }}">
                                <input class="form-check-input permission-check"
                                       ...
                                       onchange="highlightPermissionCheck(this)">
...
<div class="d-flex justify-content-end gap-2 mt-4">
    <a href="{{ route('admin.users.index') }}" class="btn btn-outline-secondary" data-bs-dismiss="modal" type="button">
