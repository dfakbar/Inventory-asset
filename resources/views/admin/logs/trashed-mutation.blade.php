...
@section('title', 'Log Mutasi Terhapus')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.logs.mutation') }}">Log Mutasi</a></li>
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="fw-bold mb-0">
            <i class="bi bi-trash text-danger me-2"></i>Log Mutasi Terhapus
        </h4>
        <p class="text-muted small mb-0 mt-1">Log yang dihapus akan otomatis terhapus permanen setelah 30 hari</p>
    </div>
    <a href="{{ route('admin.logs.mutation') }}" class="btn btn-outline-secondary btn-sm">
...
<div class="card shadow-sm border-0">
    <div class="card-body p-0">
        <form id="restoreForm" method="POST" action="{{ route('admin.logs.mutation.restore') }}">
            @csrf
            @method('PATCH')
