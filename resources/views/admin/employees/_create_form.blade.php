    ...
    <div class="col-12 col-lg-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.employees.store') }}" method="POST" id="employeeCreateForm" novalidate>
                    @csrf
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="{{ route('admin.employees.index') }}" class="btn btn-outline-secondary" data-bs-dismiss="modal" type="button">
