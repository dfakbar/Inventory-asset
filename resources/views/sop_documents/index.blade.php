...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body p-0">
        @if ($documents->isEmpty() && request()->hasAny(['search', 'type', 'date_from', 'date_to']))
            <div class="p-3 pb-0">
                @include('partials._not_found', [
                    'entity'   => 'dokumen',
                    'resetUrl' => route('documents.index'),
                ])
            </div>
        @endif
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5 text-muted">
                                ...
                                @if(request()->hasAny(['search', 'type', 'date_from', 'date_to']))
                                    ...
                                    <small><a href="{{ route('documents.index') }}">Hapus pencarian &amp; filter</a></small>
                                @else
