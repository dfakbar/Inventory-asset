...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('assets/{asset}/maintenances/{maintenance}', [AssetController::class, 'updateMaintenance'])->name('assets.maintenances.update')->middleware('throttle:300,1,assets');
